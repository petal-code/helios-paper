...
Random AQI installation at 40% coverage and 60% efficacy reduced the final epidemic size by `r signif(100 * flu_pct_reduction_no_intervention_4$mean_pct_reduction, 3)`% (range X%-Y%), compared with only `r signif(100 * covid_pct_reduction_no_intervention_4$mean_pct_reduction, 2)`% (range X%-Y%) for the SARS-CoV-2 archetype under the same settings (Figure 4A & 4E).
