...
Random AQI installation at 40% coverage and 60% efficacy reduced the final epidemic size by `r signif(100 * pct_reduction_no_intervention("flu", "epidemic_final_size", "Random", 0.6, 0.4), 3)`% (range X%-Y%), compared with only `r signif(100 * pct_reduction_no_intervention("sars_cov_2", "epidemic_final_size", "Random", 0.6, 0.4), 2)`% (range X%-Y%) for the SARS-CoV-2 archetype under the same settings (Figure 4A & 4E).
