...
Without intervention, the peak incidence of the influenza archetype was 18.1 per 1,000 (range X-Y) with a final epidemic size of 61.1% of total population (range X%-Y%), whereas the SARS-CoV-2 archetype yielded a peak incidence of 40.8 per 1,000 (range X-Y) and a final epidemic size of 89.9% of total population (range X%-Y%).
...
Random AQI installation at 40% coverage and 60% efficacy reduced the final epidemic size by 22.2% (range X%-Y%), compared with only 6.5% (range X%-Y%) for the SARS-CoV-2 archetype under the same settings (Figure 4A & 4E).

Increasing either efficacy or coverage yielded similar increases in the impact on epidemic peak, timing and final size.
For the influenza archetype, expanding randomly allocated coverage from 40% to 60% at 40% efficacy lowered the final epidemic size by 9.8%, approximately matching the 11.2% from instead increasing efficacy from 40% to 60% while holding coverage at 40% (Figure 4E).
...
For the influenza archetype at 60% efficacy, the random strategy required 60% coverage to reach an average peak daily incidence of 6.41 per 1,000, while the targeted strategy achieved the same result with only 40% coverage, producing an average peak daily incidence of 6.47 per 1,000 (Figure 4G).
This pattern also held at lower coverage levels: the random strategy’s result at 40% coverage (average peak daily incidence of 10.6 per 1,000) matched the targeted strategy’s outcome at just 20% coverage, where peak daily incidence was 11.3 per 1,000 (Figure 4G).
