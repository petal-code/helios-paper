...
The same comparisons in the COVID-19 archetype delivered only `r signif(100 * pct_reduction("sars_cov_2", "epidemic_final_size", "Random", 0.4, 0.6, 0.4, 0.4), 3)`% and `r signif(100 * pct_reduction("sars_cov_2", "epidemic_final_size", "Random", 0.6, 0.4, 0.4, 0.4), 3)`% reductions, highlighting its greater resistance to control.
...
* Rate of reduction in disease burden higher for influenza archetype over COVID-19 archetype
