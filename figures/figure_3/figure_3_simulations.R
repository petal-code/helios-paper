...
run_parallel_simulations <- function(parameter_lists, cores = detectCores() - 1) {
...
saveRDS(results_df, "figure_3_simulation_summary.rds")
saveRDS(results, "figure_3_simulation_full_results.rds")